...
export default function Shape({ count, setCount, checkChecked, setFormData, formData }) {
  ...
  return (
    <>
      ...
      <ScrollContainer tw='max-w-full grid grid-rows-3 gap-[10px] p-3 relative grid-cols-[repeat(4, 160px)]'>
